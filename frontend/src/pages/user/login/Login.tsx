...
import { AuthContext, useAuth } from "../../../core/context/authContext";
import { isSucess, isSucessR } from "../../../core/utils/rest/restUtils";
    ...
    <Container maxWidth="sm" sx={{ mt: "8rem" }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate autoComplete="off">
        ...
        >
          ...
          <Button
            style={{ marginTop: "1rem", backgroundColor: "#EF4649" }}
            variant="contained"
            type="submit"
          >
            Entrar
